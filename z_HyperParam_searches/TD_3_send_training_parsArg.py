...
import argparse
import numpy as np
from TD_3.FeedForward.HyperParam_tuning.TD3_train import TD3_train
...
print(values, "\n")
np.save('/home/px19783/Two_joint_arm/TD_3/FeedForward/HyperParam_tuning/Results/DDPG_FF_HyperParameter_s' + str(
