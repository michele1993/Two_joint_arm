...
# use following arguments: -c 1 -t 70 -m 10  --cmd python Reinf_send_traing_parsArg.py
# or -c 1 -t 70 -m 10 -g1  --cmd python Parallel_MultiP_Reinf_main.py
...
actor_ln = torch.linspace(0.000005,0.00075,5)
