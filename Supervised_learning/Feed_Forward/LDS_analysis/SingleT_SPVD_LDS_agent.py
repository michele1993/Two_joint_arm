...
class SingTSpvsd_Linear_DS_agent(nn.Module):

    def __init__(self, t_step,n_steps,ln_rate ,dev,action_s=2,h_s = 10, input_s=2, h_nn_s = 256 ): # h_s = 25; h_nn_s = 116
    ...
    def forward(self, target):
        ...
        actions = torch.zeros((self.action_s, self.n_steps)).to(self.dev)
