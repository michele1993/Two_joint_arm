...
# and if Q value for update action is more than 1 std from this distribution, skip update to actor
# until Q estimates back to normal
...
print("time_window_steps = 1","ln_rate_c = 0.001","ln_rate_a = 0.000005","std = 0.025")
...
for ep in range(episodes):
    ...
    if ep > start_a_upd and confidence <= 0.85:#0.85:#1:# and ep % actor_update:#update:#1: #0.22:
