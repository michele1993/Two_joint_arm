...
# NOT USED FOR NOW, NEED TO ADAPT IT!!
class TD3:

    def __init__(self,actor,critic1,critic2,decay_upd,n_arms,dev, t_policy_noise=0.2,t_noise_clip=0.5 ,actor_update=2,discount=1):
        ...
        self.critic_target_1 = Critic_NN(input_size=c_input_s).to(self.dev)
        ...
        self.critic_target_2 = Critic_NN(input_size=c_input_s).to(self.dev)
