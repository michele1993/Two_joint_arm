...
if not search_hyperParam:
    ...
    if allow_complex:
        ...
        accuracy_file = '/home/px19783/Two_joint_arm/MBDPG_MemBuffer/Linear_DynamicalSystem/MultiTarget/Result/MT_LDS_MBDPG_training_acc_test_s' + str(seed) + '_' + str(i) + '_oneArmOptim_stop_2.pt'
        actor_file = '/home/px19783/Two_joint_arm/MBDPG_MemBuffer/Linear_DynamicalSystem/MultiTarget/Result/MT_LDS_MBDPG_actor_test_s' + str(seed) + '_' + str(i) + '_oneArmOptim_stop_2.pt'
        model_file = '/home/px19783/Two_joint_arm/MBDPG_MemBuffer/Linear_DynamicalSystem/MultiTarget/Result/MT_LDS_MBDPG_model_test_s' + str(seed) + '_' + str(i) + '_oneArmOptim_stop_2.pt'
        actor_file_D = '/home/px19783/Two_joint_arm/MBDPG_MemBuffer/Linear_DynamicalSystem/MultiTarget/Result/MT_LDS_MBDPG_actor_D_test_s'+str(seed)+'_'+str(i)+'_oneArmOptim_stop_2.pt'
        actor_file_P = '/home/px19783/Two_joint_arm/MBDPG_MemBuffer/Linear_DynamicalSystem/MultiTarget/Result/MT_LDS_MBDPG_actor_P_test_s' + str(seed) + '_' + str(i) + '_oneArmOptim_stop_2.pt'
...
training_arm = Stopping_FF_Parall_Arm_model(tspan, x0, decay,dev, n_arms=overall_n_traj)
...
for ep in range(1, episodes):
    ...
    if ep % 5000 == 0:  # decays works better if applied every 10 eps
        std *= std_decay
