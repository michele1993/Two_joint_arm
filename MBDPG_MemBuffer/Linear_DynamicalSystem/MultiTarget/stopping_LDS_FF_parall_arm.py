...
class Stopping_FF_Parall_Arm_model:

    def __init__(self,tspan,x0,decay,dev, n_arms=10, height=1.8, mass=80):
    ...
    def dynamical_system(self,y,u): # create equivalent 1st order dynamical system of equations to be passed to solve_ivp
        ...
        return torch.cat([d_thet, d_eq, y[:, 6:8] - self.c_decay * torques, u - self.c_decay * y[:, 6:8]], dim=1)
