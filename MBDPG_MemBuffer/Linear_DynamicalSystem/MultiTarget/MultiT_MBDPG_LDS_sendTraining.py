...
parser.add_argument('--modelLr',    '-m', type=float, nargs='?',default= 5.2500e-03) #5.2500e-03 # 5e-05
parser.add_argument('--actorLr',   '-a', type=float, nargs='?', default= 1.0000e-04) #1.0000e-04 #1e-05
